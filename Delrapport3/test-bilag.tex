...
Test specification:\\
It should not be hard to test these functions, because we easyly can test if the search gives the right output. The add and delete functionality should also be easy to test, because of its easy useability.\\
