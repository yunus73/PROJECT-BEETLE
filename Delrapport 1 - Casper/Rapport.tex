...
\begin{center}
Figure 1: Skill-matrix \footnote{http://www.dummies.com/how-to/content/how-to-create-a-skills-matrix.html}
\end{center}
...
In addition to that, we've got an interest-parametre represented by either the value 0 or 1, and represents the group member's willingness to work with the associated skill.\footnote{Bernd Bruegge, Allen H.Dutoit-Third Edition. Object-Oriented Software Engineering. Page(568)}

With the skill-matrix created, the necessities of the product had to be established.
\\

\begin{center}
	Figure 2: Work Breakdown Structure \footnote{http://en.wikipedia.org/wiki/Work \underline breakdown \underline structure}
...
Through succesful breakdown of the work-burden, an approximate scheduling was created depicting the deadlines for parts of the product as well as the necessary hours for completion. This is all showcased in figure 3.\footnote{Bernd Bruegge, Allen H.Dutoit-Third Edition. Object-Oriented Software Engineering. Page(568)}
\newpage
...
From the update-page, the database can be updated and entries added, edited or removed.	\footnote{Bernd Bruegge, Allen H.Dutoit-Third Edition. Object-Oriented Software Engineering. Page(568)}
\newpage
\begin{center}
	Figure 5: Case Diagram \footnote{Bernd Bruegge, Allen H.Dutoit-Third Edition. Object-Oriented Software Engineering. Page(14-16)}
